...
from stock_info_collector_test import StockInfoCollectorTest

class MainTestArgParse:
    ...
    def apply(self):
        ...
        if self._subparser_name == 'collect':
            StockInfoCollectorTest().runTest()
    ...
    def _add_subparser(self, psr):
        ...
        collect = sub.add_parser('collect', help='Run StockInforCollector Unit Test')
        
        self._sub_list = [ collect ]
